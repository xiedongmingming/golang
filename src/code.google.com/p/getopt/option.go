...
type Option interface { // an option can be either a flag or a value
	...
	Name() string
	IsFlag() bool   // IsFlag returns true if Option is a flag.
	Seen() bool     // Seen returns true if the flag was seen.
	Count() int     // Count returns the number of times the flag was seen.
	String() string // String returns the last value the option was set to.
	Value() Value   // Value returns the Value of the option.
